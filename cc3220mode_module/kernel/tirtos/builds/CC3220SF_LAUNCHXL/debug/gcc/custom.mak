...
linker.cmd: package/cfg/debug_pm4g.xdl
	$(SED) 's"^\"\(package/cfg/debug_pm4gcfg.cmd\)\"$""\"/media/sf_CC3220/code/cc3220mode_module/kernel/tirtos/builds/CC3220SF_LAUNCHXL/debug/gcc/\1\""' package/cfg/debug_pm4g.xdl > $@
