...
linker.cmd: package/cfg/debug_pem4.xdl
	$(SED) 's"^\"\(package/cfg/debug_pem4cfg.cmd\)\"$""\"/media/sf_CC3220/code/cc3220mode_module/kernel/tirtos/builds/CC3220SF_LAUNCHXL/debug/ccs/\1\""' package/cfg/debug_pem4.xdl > $@
