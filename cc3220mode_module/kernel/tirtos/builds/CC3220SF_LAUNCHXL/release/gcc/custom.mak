...
linker.cmd: package/cfg/release_pm4g.xdl
	$(SED) 's"^\"\(package/cfg/release_pm4gcfg.cmd\)\"$""\"/media/sf_CC3220/code/cc3220mode_module/kernel/tirtos/builds/CC3220SF_LAUNCHXL/release/gcc/\1\""' package/cfg/release_pm4g.xdl > $@
