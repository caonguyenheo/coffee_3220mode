...
linker.cmd: package/cfg/release_pem4.xdl
	$(SED) 's"^\"\(package/cfg/release_pem4cfg.cmd\)\"$""\"/media/sf_CC3220/code/cc3220mode_module/kernel/tirtos/builds/CC3220S_LAUNCHXL/release/ccs/\1\""' package/cfg/release_pem4.xdl > $@
